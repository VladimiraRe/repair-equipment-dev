...
/* harmony import */ var _section_swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./section__swiper */ "./src/js/section__swiper.js");
/* harmony import */ var _readmore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./readmore */ "./src/js/readmore.js");
...
var headerModalBtns = document.querySelectorAll('.header__wrap:nth-child(2) .header__list:first-child .header__item:nth-child(-n + 2)');
var modals = document.querySelectorAll('.modal');
var modalWrap = document.querySelector('.modal__wrapper');
var container = document.querySelector('.container');
var sidebar = document.querySelector('.sidebar');
var sidebarModalBtns = sidebar.querySelectorAll('.sidebar__icons .sidebar__icons-item:nth-child(-n + 2)');
var closeBtns = document.querySelectorAll('.modal .modal__close');
var htmlObj, closeBtn;
var modalBtnsArray = Array.from(headerModalBtns);
sidebarModalBtns.forEach(function (i) {
...
function checker() {
  for (var i = 0; i < modalBtnsArray.length; i++) {
    var catchBtn = function catchBtn(currentItem) {
      ...
      if (modals[item].classList.contains('modal--open') && document.documentElement.clientWidth >= 768) {
        htmlObj = modals[item];
      ...
      modalBtnsArray[currentItem].addEventListener('click', function () {
...
function openClose(isSidebarOpen, item) {
  ...
  openModal();
  modalWrap.addEventListener('transitionend', closeModal, {
    once: true
  });
}
...
var areaToOpen = document.querySelectorAll('.readmore__area-to-open');
var btns = document.querySelectorAll('.readmore');
var readmoreTxt = document.querySelectorAll('.readmore__txt');
var isOpen = false;

for (var i = 0; i < btns.length; i++) {
  var buttonСlick = function buttonСlick(el) {
...
var smoothLinks = document.querySelectorAll('a[href^="#scroll__"]');
var sidebarMenu = document.querySelectorAll('.sidebar__item');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _swiper_bundle_min2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./swiper-bundle.min2 */ "./src/js/swiper-bundle.min2.js");
/* harmony import */ var _swiper_bundle_min2__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_swiper_bundle_min2__WEBPACK_IMPORTED_MODULE_0__);
...
function sliderInit() {
  mySwipers = [newSwiper('.section__swiper', 1.185, [1.35, 1.7, 2.3, 2.5]), newSwiper('.section__swiper--big', 1.1, [1.3, 1.6, 2, 2.2])];
  isActive = true;
}

function sliderDestroy(mySwipers) {
  mySwipers.forEach(function (swiper) {
    Array.isArray(swiper) ? sliderDestroy(swiper) : swiper.destroy(true, true);
  });
  isActive = false;
}

function newSwiper(className, slidesPerView, breakpoints) {
  return new _swiper_bundle_min2__WEBPACK_IMPORTED_MODULE_0___default.a(className, {
...
var sidebar = document.querySelector('.sidebar');
var closeBtn = sidebar.querySelector('.sidebar__wrap--row .icon:first-child');
var container = document.querySelector('.container');
var sidebarMenu = sidebar.querySelectorAll('.sidebar__item');
checker();
window.addEventListener('resize', function () {
  checker();
});
...
function checker() {
  if (sidebar.classList.contains('sidebar--open') && document.documentElement.clientWidth >= 1440) {
    close();
  }
...
function openClose() {
  openSidebar();
  sidebar.addEventListener('transitionend', closeSidebar, {
    once: true
  });
}
