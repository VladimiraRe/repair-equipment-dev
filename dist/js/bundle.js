...
function checker() {
  for (var i = 0; i < modalBtnsArray.length; i++) {
    var catchBtn = function catchBtn(currentItem) {
      ...
      if (htmlObj.classList.contains('modal--open') && document.documentElement.clientWidth >= 768) {
...
function openClose(isSidebarOpen) {
  ...
  openModal();
  htmlObj.addEventListener('transitionend', closeModal, {
    once: true
  });
}
...
function sliderInit() {
  mySwipers = new _swiper_bundle_min2__WEBPACK_IMPORTED_MODULE_0___default.a('.section__swiper', {
  ...
  mySwipers[2] = new _swiper_bundle_min2__WEBPACK_IMPORTED_MODULE_0___default.a('.section__swiper--big', {
    direction: 'horizontal',
    spaceBetween: 16,
    slidesPerView: 1.1,
    roundLengths: true,
